 ...
 * [0] - source file path args
 * [1] - * destination file path args
 * [2] - if exists "overwritten" then destination may be overwritten otherwise may not be 
 * Output one of the following: Files have
